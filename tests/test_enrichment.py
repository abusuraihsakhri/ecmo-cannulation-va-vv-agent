"""
Automated Pytest for ecmo-cannulation-va-vv-agent Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    VvecmoEngine,
    EcmoEngine,
    EcmocannulationvavvagentEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = EcmocannulationvavvagentEnrichmentSuite()
