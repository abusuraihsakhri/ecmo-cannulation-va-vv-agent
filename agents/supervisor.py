"""
Supervisor Orchestrator & Operations Intelligence for Ecmo Cannulation Va Vv Agent.
...
class SystemSupervisor:
    """Master Distributed Component Coordinator for Ecmo Cannulation Va Vv Agent."""
    ...
    def __init__(self, model_provider: str = "mock"):
        ...
        self.llm = LLMFactory.create(model_provider, system_name="Ecmo Cannulation Va Vv Agent")
    ...
    def query_supervisory_chat(self, query: str) -> str:
        ...
        prompt = f"Supervisor inquiry for Ecmo Cannulation Va Vv Agent under AHA/ACC Guidelines / Surviving Sepsis Campaign: {query}"
