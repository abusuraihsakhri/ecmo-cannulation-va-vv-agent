"""
Live WebSocket Distributed Component Telemetry Streamer for ecmo-cannulation-va-vv-agent.
"""
import json
import asyncio
...
class TelemetryBroadcaster:
    ...
    async def broadcast_event(self, event_type: str, data: Dict[str, Any]):
        msg = json.dumps({"system": "ecmo-cannulation-va-vv-agent", "event_type": event_type, "payload": data})
